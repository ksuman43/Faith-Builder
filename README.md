...
🛠 Tech StackBackend: 
    PocketBase (SQLite, Go)    
    CLI/TUI Client: Go, Bubble Tea, Lipgloss, Bubbles
    Web Client: React, Vite, Tailwind CSS
    Ingestion Script: Node.js, gray-matter
    Build Tools: Bash, Git, UPX📂 Project StructurePlaintextfaith-builder/
...
KeyActionContextTabSwitch focus / toggle inputs
GlobalEnterSearch / Read / SelectGlobal m
